 ...
 * @author krist
 */
public class LoginMenuScreen extends javax.swing.JFrame {

    /**
     * Creates new form LoginMenuScreen
     */
    ...
    private void initComponents() {
        ...
        editAccountButton.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        editAccountButton.setText("Account");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(editAccountButton, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jMenuBar1.setPreferredSize(new java.awt.Dimension(306, 36));

        jMenu1.setText("Car Search");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginMenuScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginMenuScreen().setVisible(true);
            }
        });
    }
